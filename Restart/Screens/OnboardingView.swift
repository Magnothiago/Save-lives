            ...
            // MARK: - CENTER
                ...
                ZStack{
                    ...
                    HStack{
                        ...
                        .foregroundColor(.white).frame(width: 80,height: 80,alignment: .center).offset(x:buttonOffset)
                            .gesture(
                            DragGesture()
                                .onChanged {
                                    gesture in
                ...
                .padding().opacity(isAnimating ? 1 : 0).offset(y: isAnimating ? 0 : 49 ).animation(.easeOut(duration: 1), value: isAnimating)
            }//:VSTACK
        } //: ZSTACK
        .onAppear(perform: {
            isAnimating = true
